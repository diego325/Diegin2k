...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const  premium= ["5511998346168@s.whatsapp.net","5516994100461@s.whatsapp.net","5517991896064@s.whatsapp.net","5514998435607@s.whatsapp.net"]
...
const get = require('got')
	...
	if (messagesC.includes("tag")){
	    ...
	    if (messagesC.includes("namora comigo?")){
			client.updatePresence(from, Presence.composing)
