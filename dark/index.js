	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					group: '[❗] esse comando é permitido so para o dono! ❌',
			...
			const premium = ["5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5517991896064@s.whatsapp.net"]
